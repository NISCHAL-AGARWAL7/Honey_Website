...
export default function CartPage() {
  ...
  // Avoid hydration mismatch by not rendering cart content until mounted
  if (!mounted) {
    return <div className="container mx-auto px-4 py-24 flex justify-center"><div className="w-8 h-8 border-4 border-primary border-t-transparent rounded-full animate-spin"></div></div>;
  }
